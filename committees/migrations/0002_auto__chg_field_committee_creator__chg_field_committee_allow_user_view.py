...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Committee.creator'
        db.alter_column(u'committees_committee', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Committee.allow_user_view'
        db.alter_column(u'committees_committee', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.view_contact_form'
        db.alter_column(u'committees_committee', 'view_contact_form', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.entity'
        db.alter_column(u'committees_committee', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'Committee.owner'
        db.alter_column(u'committees_committee', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Committee.allow_anonymous_view'
        db.alter_column(u'committees_committee', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.status'
        db.alter_column(u'committees_committee', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.syndicate'
        db.alter_column(u'committees_committee', 'syndicate', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.allow_user_edit'
        db.alter_column(u'committees_committee', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.allow_member_view'
        db.alter_column(u'committees_committee', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Committee.allow_member_edit'
        db.alter_column(u'committees_committee', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Committee.creator'
        db.alter_column(u'committees_committee', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Committee.allow_user_view'
        db.alter_column(u'committees_committee', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.view_contact_form'
        db.alter_column(u'committees_committee', 'view_contact_form', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.entity'
        db.alter_column(u'committees_committee', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'Committee.owner'
        db.alter_column(u'committees_committee', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Committee.allow_anonymous_view'
        db.alter_column(u'committees_committee', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.status'
        db.alter_column(u'committees_committee', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.syndicate'
        db.alter_column(u'committees_committee', 'syndicate', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.allow_user_edit'
        db.alter_column(u'committees_committee', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.allow_member_view'
        db.alter_column(u'committees_committee', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Committee.allow_member_edit'
        db.alter_column(u'committees_committee', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'committees.committee': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'committees_committee_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'design_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'committees_committee_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'committees_committee_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'committees.officer': {
            'Meta': {'object_name': 'Officer'},
            'committee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['committees.Committee']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['committees.Position']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'committees_officer_user'", 'to': u"orm['auth.User']"})
        },
        u'committees.position': {
